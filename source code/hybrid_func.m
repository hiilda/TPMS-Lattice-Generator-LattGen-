function [F,V] = hybrid_func(rd1,app_t1,imported_mesh,inp,len,bre,wid,out_p,x1,y1,z1,cell_len_x,cell_len_y, cell_len_z,lattice_type,lattice_type2,structure_type,volumeFill, ...
...
f1 = tpms_function(x1,y1,z1,lattice_type,custom_function);                  %gets the value of f for corresponding tpms structure
f2 = tpms_function(x1,y1,z1,lattice_type2,custom_function2);
...
switch structure_type
    ...
    case "Solid"
        ...
        [isovalue1,~] = rel_den(rd1,imported_mesh,inp,len,bre,wid,cell_len_x,cell_len_y,cell_len_z,... %uses relative density to determine thickness of grading
            [],lattice_type,structure_type, out_p, x1,y1,z1,volumeFill,relDenCheck,custom_function);
        [isovalue2,~] = rel_den(rd1,imported_mesh,inp,len,bre,wid,cell_len_x,cell_len_y,cell_len_z,...
